            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Service
                        <a href="{{ url('admin/service/update/' . $Service->id) }}" type="button"
                                ...
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom01"
                                            ...
                                            value="{{ old('title_sub3', $Service->title_sub3) }}" required>
                                ...
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description_sub3" rows="5" class="form-control"
                                            ...
                                            required>{{ old('description_sub3', $Service->description_sub3) }}</textarea>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control" id="validationCustom05"
                                            ...
                                            @if(empty($Service->image_sub3)) required @endif>
                                        <div class="invalid-feedback">
                                            Please upload image.
                                        </div>
                                    </div>
                                </div>
                                @if(!empty($Service->image_sub3))
                                    <div class="row">
                                        <div class="mb-3">
                                            <img id="imgPreview" width="100px" height="100px"
                                                src="{{ asset('storage') }}/service/{{ $Service->image_sub3 }}"
                                                alt="pic" />
                                        </div>
                                    </div>
                                @endif                                  
                                @php
    $sections1 = $id != "" ? $Service->section2 : [];
