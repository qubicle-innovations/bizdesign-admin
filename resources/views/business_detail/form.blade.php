            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Business Setup
                        <a href="{{ url('admin/business') }}" type="button"
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" name="stitle"
                                    placeholder="Small Title" value="{{ old('stitle', $Business_Setup->stitle) }}"
                                    required>
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" name="mtitle"
                                    placeholder="Main Title" value="{{ old('mtitle', $Business_Setup->mtitle) }}"
                                    required>
                                <div class="invalid-feedback">
