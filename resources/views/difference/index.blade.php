            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">The Difference
                        @if($cnt==0)<a href="{{ url('admin/difference/create') }}" type="button" class="btn btn-dark waves-effect waves-light float-end">Create</a>@endif
                    </h4>
                </div>
