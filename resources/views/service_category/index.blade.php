...
<body>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Service Category
                        <a href="{{ url('admin/service/category/create') }}" type="button" class="btn btn-dark waves-effect waves-light float-end">Create</a>
                    </h4>
                </div>
    ...
    <script>
        $(document).ready(function () {
            var url = "{{ url('admin/service/category') }}";
        ...
        function delete_record(client_id) {
            var userURL = '<?php echo url("admin/service/category/delete"); ?>/' + client_id;
